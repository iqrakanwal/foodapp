...
public class FoodAdaptor extends RecyclerView.Adapter<FoodAdaptor.ImageItem> {
    private Context context;
    private ArrayList<Food> images;
    private AnimalClickListener animalClickListener;

    public FoodAdaptor(Context context, ArrayList<Food> images, AnimalClickListener animalClickListener) {
